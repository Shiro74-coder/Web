			...
			<div class="col-md-6 col-sm-6 additional-nav">
				<ul class="list-unstyled list-inline pull-right">
					...
					<li><c:choose>
							...
							<c:otherwise>
								<%-- 1. Link đến trang Profile cá nhân --%>
								<a href="${pageContext.request.contextPath}/member/profile">${sessionScope.account.fullname}</a>

								<%-- 2. Link đến trang THÊM MỚI danh mục --%>
    | <a href="${pageContext.request.contextPath}/member/categories/add">Thêm
									danh mục</a>
